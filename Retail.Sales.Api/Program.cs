...
using Retail.Sales.Api.Application.Decorators;
using Retail.Sales.Api.Application.Facades;
...
builder.Services.AddScoped<RegisterSaleFacade>();
builder.Services.AddScoped<IRegisterSaleFacade>(sp =>
{
    var inner = sp.GetRequiredService<RegisterSaleFacade>();
    var logger = sp.GetRequiredService<ILogger<RegisterSaleLoggingDecorator>>();
    return new RegisterSaleLoggingDecorator(inner, logger);
});
builder.Services.AddScoped<IListSalesQuery, ListSalesQuery>();
